...
- recognized: true — если сорт/вид/культивар найден:
  - nameEn — каноническое название сорта/вида БЕЗ названия рода
    (например, для Peperomia prostrata → "Prostrata", для Rosa 'Double Delight' → "Double Delight")
  - nameRu — устоявшееся русское название сорта/вида, если существует;
    если нормативного русского названия нет — транслитерация или
    наиболее употребимый русский вариант
